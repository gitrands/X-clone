...
const SignUpPage = () => {
    ...
    const { mutate, isError: mutationError, isPending, error } = useMutation({
        ...
        <div className='max-w-screen-xl mx-auto flex h-screen px-10'>
            ...
            <div className='flex-1 flex flex-col justify-center items-center'>
                <form className='lg:w-2/3 mx-auto md:mx-20 flex gap-4 flex-col' onSubmit={handleSubmit}>
                    ...
                    <button className='btn rounded-full btn-primary text-white' type="submit">{isPending ? "Loading ... " : "Sign up "}</button>
                    {isError && <p className='text-red-500'>Fullname is required</p>}
                </form>
